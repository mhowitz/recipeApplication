...
//  ADD ERROR HANDLING SO IF USER SEARCH IS NOT VALID, A MODAL APPEARS OR TEXT DISPLAYED ON SCREEN FOR USER TO TRY AGAIN (NO ALERTS)
//  ONCE THESE ARE DONE: WE CAN ADD DRAGGABLE FEATURES (FOR TO TRY AND FAVORITES SECTION) AND LOCAL STORAGE